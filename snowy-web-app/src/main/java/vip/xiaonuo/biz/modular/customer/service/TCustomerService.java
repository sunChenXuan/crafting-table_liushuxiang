...
public interface TCustomerService extends IService<TCustomer> {
     ...
     * @date  2023/09/20 17:03
     */
    Page<TCustomer> page(TCustomerPageParam tCustomerPageParam);
     ...
     * @date  2023/09/20 17:03
     */
    void add(TCustomerAddParam tCustomerAddParam);
     ...
     * @date  2023/09/20 17:03
     */
    void edit(TCustomerEditParam tCustomerEditParam);
     ...
     * @date  2023/09/20 17:03
     */
    void delete(List<TCustomerIdParam> tCustomerIdParamList);
     ...
     * @date  2023/09/20 17:03
     */
    TCustomer detail(TCustomerIdParam tCustomerIdParam);
     ...
     * @date  2023/09/20 17:03
     **/
    TCustomer queryEntity(String id);
}
